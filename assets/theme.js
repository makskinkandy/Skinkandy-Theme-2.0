...
(function(){
  ...
  DOMready(function(){
    ...
    const dropdowns = document.querySelectorAll('.site-nav__link--has-dropdown');
  ...
  //Change heading tag for SS
  // Function to replace the h2 with h3
  function replaceH2WithH3() {
    const h2Element = document.querySelector('h2.ss__title.ss__title--recommendation');
    if (h2Element) {
        const h3Element = document.createElement('h3');
        [...h2Element.attributes].forEach(attr => h3Element.setAttribute(attr.name, attr.value));
